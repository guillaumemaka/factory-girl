          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                return _context5.abrupt('return', _Promise.then(function () {
...
var DefaultAdapter = function () {
  ...
  _createClass(DefaultAdapter, [{
    ...
    key: 'saveMany',
    value: function () {
      var _ref2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(models, Model) {
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    key: 'destroy',
    value: function () {
      var _ref3 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3(model, Model) {
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt('return', _Promise.resolve(model.destroy()).then(function () {
                  return model;
                }));
